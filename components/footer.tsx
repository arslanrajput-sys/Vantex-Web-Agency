    ...
    <footer className="border-t border-line bg-ink py-12">
      <div className="shell">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <FooterLinks title="Services" links={[["Custom websites","/services"],["Landing pages","/services"],["Website redesign","/services"],["AI receptionist chatbots","/services"],["SEO & performance","/services"]]}/>
