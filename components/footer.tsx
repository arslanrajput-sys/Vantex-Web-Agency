    ...
    <footer className="border-t border-line bg-ink py-12">
      <div className="shell">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <FooterLinks title="Services" links={[["Custom websites","/services/#custom-website-design-development"],["Landing pages","/services/#landing-page-design"],["Website redesign","/services/#website-redesign-optimization"],["AI receptionist chatbots","/services/#ai-chatbot-integration"],["SEO & performance","/services/#seo-performance-optimization"]]}/>
