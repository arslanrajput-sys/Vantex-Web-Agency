...
const packages = [
  ...
  {name:"Growth Platform",scope:"Up to 12 Pages",price:"$899",for:"For growing businesses that need deeper content, smarter workflows, and room to scale.",features:["Separate monthly maintenance fee applies","Up to 12 custom website pages","Scalable sitemap and content structure","Advanced forms and workflows","CMS-ready content setup","Third-party integrations","Analytics setup"],cta:"Plan My Growth Platform"},
