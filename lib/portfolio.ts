...
export const portfolioProjects: readonly PortfolioProject[] = [
  ...
  { name:"SoCal Cleaning Company", type:"Local service website", url:"https://brightnest-silk.vercel.app/", domain:"brightnest-silk.vercel.app", image:"/portfolio/socal-cleaning.webp", alt:"SoCal Cleaning Company website homepage", summary:"A bright, trust-first cleaning website that makes services, coverage, and quote requests easy to understand on any screen.", highlights:["Fast quote journey","Service-area messaging","Mobile-first contact"] },
