...
export const portfolioProjects: readonly PortfolioProject[] = [
  { name:"SUNNYCELLS", type:"Ecommerce wellness website", url:"https://demo-ryze.vercel.app/", domain:"demo-ryze.vercel.app", image:"/portfolio/sunnycells.webp", alt:"SUNNYCELLS Metabolic Morning Blend ecommerce website homepage", summary:"A warm, conversion-focused supplement storefront that turns a daily wellness product into a clear, repeatable morning ritual.", highlights:["Product-led art direction","Subscription-focused CTA","Ingredient storytelling"], homeFeatured:true },
  ...
  { name:"The Fade Room", type:"Barber studio website", url:"https://the-fade-room-xi.vercel.app/", domain:"the-fade-room-xi.vercel.app", image:"/portfolio/the-fade-room.webp", alt:"The Fade Room VIP Barber Studio website homepage", summary:"A bold, editorial booking experience for an Orange, California barber studio, pairing premium brand direction with services, social proof, and a direct appointment path.", highlights:["Editorial brand system","Booking-focused journey","Review-led trust"], homeFeatured:true },
  { name:"Ultra Roofer Peak Authority", type:"Roofing service website", url:"https://ultra-roofer.vercel.app/", domain:"ultra-roofer.vercel.app", image:"/portfolio/ultra-roofer.webp", alt:"Ultra Roofer Peak Authority Los Angeles roofing website homepage", summary:"A high-contrast Los Angeles roofing website that frames inspections, repairs, and replacements around clear scope, documented work, and fast contact.", highlights:["Inspection-first funnel","Service-area positioning","24-hour contact path"], homeFeatured:true },
