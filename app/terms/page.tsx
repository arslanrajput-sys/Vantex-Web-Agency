  ...
  return (
    <main className="min-h-screen bg-ink">
      ...
      <article className="legal-copy shell py-16 md:py-24">
        <p className="section-label">Legal</p><h1>Terms of Use</h1><p className="legal-date">Last updated: August 6, 2026</p>
        ...
        <h2>Intellectual property</h2><p>The VantexWeb name, visual identity, original site content, and design are protected by applicable intellectual-property laws. Concept projects are demonstration work and are labeled accordingly.</p>
