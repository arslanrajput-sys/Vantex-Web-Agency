  ...
  return (
    <main className="min-h-screen bg-ink">
      ...
      <article className="legal-copy shell py-16 md:py-24">
        <p className="section-label">Legal</p><h1>Privacy Policy</h1><p className="legal-date">Last updated: August 6, 2026</p>
        ...
        <h2>Retention and choices</h2><p>We retain inquiry details only as long as reasonably needed for business and legal purposes. You can request access, correction, or deletion by emailing <a href={`mailto:${email}`}>{email}</a>.</p>
