...
export default function PricingPage() {
  return <><Navbar/><main><section id="top" className="pricing-page-hero"><div className="shell pricing-page-hero-layout"><div><h1>Clear package prices.<br/><span>A scope built around you.</span></h1><p>Choose the closest package to understand the investment. We will confirm the pages, functionality, integrations, and delivery plan before you commit.</p></div><div className="pricing-hero-note"><h2>What these prices mean</h2><ul>{scopeNotes.map((note) => <li key={note}><Check size={16}/><span>{note}</span></li>)}</ul></div></div></section><Pricing showHeading={false}/><FAQ items={pricingFaqs} title="Straight answers about packages and pricing." copy="Understand what affects the final quote, how projects are structured, and what happens when your needs fall between packages."/><FinalCta/></main><Footer/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(pricingFaqSchema).replace(/</g,"\\u003c")}}/></>;
}
